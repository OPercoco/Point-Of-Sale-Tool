...
public class RegisterTest {
	...
	public void testinput() throws ParseException, inputException{
		...
		String[] rentaloutput={"LADW", "9/3/15", "5", "10", "9/8/15", "1.99", "5", "9.95", "10", "1.0", "8.95"};
		...
		String[] rentaloutput3={"JAKD", "9/3/15", "6", "0", "9/9/15", "2.99", "3", "8.97", "0", "0.0", "8.97"};
				
		assertArrayEquals(rentaloutput3, register.PointOfSaleTool(rentaltest3));
		
		String[] rentaltest4 = {"JAKR", "7/2/20", "4", "50"};
		String[] rentaloutput4={"JAKR", "7/2/20", "4", "50", "7/6/20", "2.99", "1", "2.99", "50", "1.5", "1.49"};
